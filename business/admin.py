...
from .models import Category, Attribute, Item, ItemMedia, ProductAttributeValue, Notification
...
class ItemAdmin(admin.ModelAdmin):
    ...
    inlines = [ProductAttributeValueInline, ItemMediaInline]
    ...
    def chat_with_seller(self, obj):
        if obj.seller:
            ...
            return format_html(
                '<a class="button" href="{}" target="_blank" style="background-color: #4f46e5; color: white; padding: 4px 10px; border-radius: 4px; text-decoration: none;">Chat</a>',
                url,
            )
        return "-"
