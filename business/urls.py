...
urlpatterns = [
    ...
    path(
        ...
        views.remove_from_cart_redirect,
        name="remove_from_cart",
    ),
    path(
        "company/<int:company_id>/",
        views.view_company_profile_redirect,
        name="view_company_profile",
    ),
    path(
        "company/edit/", company_views.edit_company_profile, name="edit_company_profile"
    ),
    path("company/dashboard/", views.company_dashboard, name="company_dashboard"),
    path("sell/", views.post_item, name="post_item"),
    path("manage/", views.manage_items, name="manage_items"),
    path("edit/<int:item_id>/", views.edit_item, name="edit_item"),
    path("media/<int:media_id>/delete/", views.delete_item_media, name="delete_item_media"),
    path("delete/<int:item_id>/", views.delete_item, name="delete_item"),
    path(
        "dashboard/", views.personal_dashboard, name="personal_dashboard"
