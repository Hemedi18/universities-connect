...
class Command(BaseCommand):
    ...
    def handle(self, *args, **kwargs):
        locations = {
            ...
            "Morogoro": ["Gairo", "Kilombero", "Kilosa", "Morogoro", "Mvomero", "Ulanga", "Malinyi"],
            "Mtwara": ["Masasi", "Mtwara", "Nanyumbu", "Newala", "Tandahimba"],
            "Mwanza": ["Ilemela", "Kwimba", "Magu", "Misungwi", "Mwanza", "Sengerema", "Ukerewe"],
        ...
        self.stdout.write(self.style.SUCCESS('Successfully populated regions and districts'))